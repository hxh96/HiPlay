...
class Common_util_pub
{
	...
	function __construct($appid,$mchid,$key,$appsecret) {
		$this->appid 	 = C('WxPayConf_pub.APPID');
		$this->mchid 	 = C('WxPayConf_pub.MCHID');
		$this->key  	 = C('WxPayConf_pub.KEY');
		$this->appsecret = C('WxPayConf_pub.APPSECRET');
	}
...
class JsApi_pub extends Common_util_pub
{
	...
	function __construct($appid,$mchid,$key,$appsecret) 
	{
		Common_util_pub::__construct(
			'wx7b0e83e677e7f200',
			'1503382621',
			'JkiyKL2rainZPPsL7CIfDYYVVE3eIcxj',
			'a35344f6d95c166e56fab2d741fa280a');
		//设置curl超时时间
		$this->curl_timeout = 60;
	}
