...
<div class="public-ifame mt20">
	...
	<div class="public-content">
		...
		<div class="public-content-cont">
			...
			<div class="form-group">
				<label for="">名称</label>
				<input class="form-input-txt" type="text" placeholder="请输入名称" name="name" value="<?php echo ($name); ?>" />
			</div>
			<div class="form-group">
				...
				<input  id="file_upload_image" name="img" type="hidden" value="<?php echo ($img); ?>" multiple="true">
			</div>
			<div class="form-group">
				<label for="">是否外链</label>
				<select name="is_link" class="form-select">
					<option value="1" <?php echo ($is_link==1?'selected':''); ?>>是</option>
					<option value="0" <?php echo ($is_link==0?'selected':''); ?>>否</option>
				</select>
			</div>
			<div class="form-group">
				<label for="">链接地址</label>
				<input class="form-input-txt" type="text" placeholder="请输入链接地址"  name="url" value="<?php echo ($url); ?>" />
	...
	<script>
		var SCOPE = {
			'redirect_url' : "<?php echo U('Banner/editData');?>",
