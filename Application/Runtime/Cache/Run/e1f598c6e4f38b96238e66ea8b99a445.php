...
<div class="public-ifame mt20">
    ...
    <div class="public-content">
        <div class="public-content-header">
            <div class="public-content-right fr">
                <a href="<?php echo U('Category/add',['pid'=>$pid]);?>" style="height: 24px; width: 60px;border: 1px solid #ccc;font-size: 12px;text-align:center">添加信息</a>
            </div>
            <h3><?php echo ($menu); ?></h3>
        ...
        <div class="public-content-cont">
            <table class="public-cont-table">
                ...
                <?php if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                        <td><?php echo ($v["id"]); ?></td>
                        <td><a href="<?php echo U('Category/index',['pid'=>$v[id]]);?>" arrt-pid="<?php echo ($v["id"]); ?>" class="categoryName" style="color: #6eb6de"><?php echo ($v["name"]); ?></a></td>
                        <td><?php echo ($v["p_name"]); ?></td>
                        <td><?php echo ($v["sort"]); ?></td>
                        <td><img src="<?php echo ($v["img"]); ?>" width="50px"/></td>
    ...
    <script>
        var SCOPE = {
            'redirect_url' : "<?php echo U('Category/delete');?>",
            'jump_url' : "<?php echo U('Category/index');?>"
        };
...
//                var pid = $(this).attr('arrt-pid');
//                $.ajax({
//                    type:'post',
//                    url:"<?php echo U('Category/checkPid');?>",
//                    data:'pid='+pid,
//                    dataType:'json',
//                    success:function(data){
//                        if(data.code == 1){
//                            location.href = "<?php echo U('Category/index');?>?pid="+pid;
//                        }else {
//                            return dialog.error(data.message);
//                        }
//                    }
