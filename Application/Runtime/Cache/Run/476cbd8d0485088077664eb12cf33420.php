...
<div class="public-ifame mt20">
	...
	<div class="public-content">
		...
		<div class="public-content-cont">
			...
			<input class="form-input-txt" type="hidden" name="id" value="<?php echo ($id); ?>" />
				<div class="form-group">
					<label for="">用户名</label>
					<input class="form-input-txt" type="text" placeholder="请输入账号" name="username" value="<?php echo ($username); ?>" />
				</div>
				<div class="form-group">
					<label for="">新密码</label>
				...
				<div class="form-group">
					<label for="">手机号</label>
					<input class="form-input-txt" type="text" name="phone" placeholder="请输入11位手机号" value="<?php echo ($phone); ?>" />
				</div>
			<!--<div class="form-group">-->
				<!--<label for="">缩略图</label>-->
			...
			<div class="form-group" style="margin-left:150px;">
				...
				<button class="return-btn" ><a class="btn-a" href="<?php echo U('Admin/index');?>">返  回</a></button>
			</div>
		</div>
	</div>
	...
	<script>
		var SCOPE = {
			'redirect_url' : "<?php echo U('Admin/editData');?>",
