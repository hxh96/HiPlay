...
<div class="public-header-warrp">
	<div class="public-header">
		<div class="content">
			<div class="public-header-logo"><a href=""><i>Logo</i><h3><?php echo W('Public/web_name');?></h3></a></div>
			<div class="public-header-admin fr">
				<p class="admin-name"><?php echo ($username); ?> 管理员 您好！</p>
...
<div class="public-ifame mt20">
			...
			<ul class="left-nav-list">
				<li class="public-ifame-item">
					...
					<div class="ifame-item-sub">
						<ul>
							<li class="active"><a href="<?php echo U('System/index');?>" target="content">网站配置</a></li>
	...
	<div class="public-content">
		...
		<div class="public-content-cont">
			...
			<div class="form-group">
				...
				<input class="form-input-txt" type="text" name="var" value="" />
			</div>
			<div class="form-group">
				<label for="">栏目内容</label>
				<textarea class="form-input-textara" type="text" name="data"></textarea>
			</div>
			<div class="form-group">
	...
	<script>
		var SCOPE = {
			'redirect_url' : "<?php echo U('System/addData');?>",
