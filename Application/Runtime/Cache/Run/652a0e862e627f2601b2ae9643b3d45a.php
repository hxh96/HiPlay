...
<div class="public-ifame mt20">
	...
	<div class="public-content">
		...
		<div class="public-content-cont">
			...
			<div class="form-group">
				...
				<input class="form-input-txt" type="text" placeholder="请输入规则名称" name="name" value="" />
			</div>
			<div class="form-group">
				<label for="">规则变量</label>
				<input class="form-input-txt" type="text" placeholder="请输入规则变量"  name="var" value="" />
				<span style="color: red">* 该栏目由开发者填写</span>
			</div>
			<div class="form-group">
				<label for="">规则值</label>
				<input class="form-input-txt" type="text" placeholder="请输入规则值" name="value" value="" />
			</div>
	...
	<script>
		var SCOPE = {
			'redirect_url' : "<?php echo U('IntegralRules/addData');?>",
