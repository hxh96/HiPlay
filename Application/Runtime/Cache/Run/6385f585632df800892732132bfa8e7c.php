...
<div class="public-ifame mt20">
	...
	<div class="public-content">
		...
		<div class="public-content-cont">
			...
			<div class="form-group">
				...
				<input class="form-input-txt" type="text" placeholder="请输入费用名称" name="activity_cate_name" value="<?php echo ($activity_cate_name); ?>" />
			</div>
			...
			<div class="form-group" style="margin-left:150px;">
				...
				<button class="return-btn" ><a class="btn-a" href="<?php echo U('ActivityCate/index');?>">返  回</a></button>
			</div>
		</div>
	</div>
	...
	<script>
		var SCOPE = {
			'redirect_url' : "<?php echo U('ActivityCate/editData');?>",
			'jump_url' : "<?php echo U('ActivityCate/index');?>"
		};
