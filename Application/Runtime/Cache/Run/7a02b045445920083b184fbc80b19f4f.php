...
<div class="public-ifame mt20">
		...
		<div class="public-content-cont">
			...
			<input class="form-input-txt" type="hidden" name="id" value="<?php echo ($id); ?>" />
				<div class="form-group">
					...
					<input class="form-input-txt" type="text" placeholder="请输入规则名称" name="name" value="<?php echo ($name); ?>" />
				</div>
				<div class="form-group">
					<label for="">规则变量</label>
					<input class="form-input-txt" type="text" placeholder="请输入规则变量" name="var" value="<?php echo ($var); ?>" />
					<span style="color: red">* 该栏目由开发者填写</span>
				</div>
				<div class="form-group">
					<label for="">规则值</label>
					<input class="form-input-txt" type="text" name="value" placeholder="请输入规则值" value="<?php echo ($value); ?>" />
				</div>
			<!--<div class="form-group">-->
				<!--<label for="">缩略图</label>-->
			...
			<div class="form-group" style="margin-left:150px;">
				...
				<button class="return-btn" ><a class="btn-a" href="<?php echo U('IntegralRules/index');?>">返  回</a></button>
			</div>
		</div>
	</div>
	...
	<script>
		var SCOPE = {
			'redirect_url' : "<?php echo U('IntegralRules/editData');?>",
			'jump_url' : "<?php echo U('IntegralRules/index');?>"
		};
