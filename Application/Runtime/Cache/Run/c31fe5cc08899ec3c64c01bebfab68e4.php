...
<div class="public-ifame mt20">
        ...
        <div class="public-content-cont">
            <table class="public-cont-table">
                ...
                <?php if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                        <td><?php echo ($v["id"]); ?></td>
                        <td><a href="<?php echo U('Activity/index',['id'=>$v[activity_id]]);?>" style="color: #4a77d4"><?php echo ($v["activity_name"]); ?></a></td>
                        <td><a href="<?php echo U('User/index',['id'=>$v[comment_user_id]]);?>" style="color: #00C1B3"><?php echo ($v["user_name"]); ?></a></td>
                        <td><?php echo ($v["act_friendly"]); ?></td>
                        <td><?php echo ($v["is_punctual"]); ?></td>
                        <td><?php echo ($v["active_degree"]); ?></td>
                        <td><?php echo ($v["comment_content"]); ?></td>
                        <td><a href="<?php echo U('User/index',['id'=>$v[comment_object_user_id]]);?>" style="color: #00C1B3"><?php echo ($v["comment_object_user_name"]); ?></a></td>
                        <td>
    ...
    <script>
        var SCOPE = {
            'redirect_url' : "<?php echo U('UserComments/delete');?>",
            'jump_url' : "<?php echo U('UserComments/index');?>"
        };
