...
<div class="public-ifame mt20">
    ...
    <div class="public-content">
        <div class="public-content-header">
            <!--<div class="public-content-right fr">-->
                <!--<a href="<?php echo U('Admin/add');?>" style="height: 24px; width: 60px;border: 1px solid #ccc;font-size: 12px;text-align:center">添加信息</a>-->
            <!--</div>-->
            <h3><?php echo ($menu); ?></h3>
    ...
    <script>
        var SCOPE = {
            'redirect_url' : "<?php echo U('UserPhotoAlbum/delete');?>",
            'jump_url' : "<?php echo U('UserPhotoAlbum/index');?>"
        };
    </script>
