...
<div class="public-ifame mt20">
    ...
    <div class="public-content">
        <div class="public-content-header">
            <div class="public-content-right fr">
                <a href="<?php echo U('System/add');?>" style="height: 24px; width: 60px;border: 1px solid #ccc;font-size: 12px;text-align:center">添加信息</a>
            </div>
            <h3><?php echo ($menu); ?></h3>
        ...
        <div class="public-content-cont">
            <table class="public-cont-table">
                <tr>
                    ...
                    <th style="width:20%">栏目变量</th>
                    <th style="width:20%">栏目值</th>
                    <th style="width:20%">栏目图片</th>
                ...
                <?php if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td><img src="<?php echo ($v["img"]); ?>" width="50"/> </td>
                        <td>
                            <div class="table-fun">
                                <a href="<?php echo U('System/edit',['id'=>$v[id]]);?>">修改</a>
                                <a href="javaScript:;" attr-id="<?php echo ($v["id"]); ?>" attr-name="删除" class="tp-delete" style="color: red">删除</a>
                            </div>
                        </td>
    ...
    <script>
        var SCOPE = {
            'redirect_url' : "<?php echo U('System/delete');?>",
