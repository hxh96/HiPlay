...
<div class="public-ifame mt20">
	...
	<!-- 内容模块头 -->
		...
		<div class="public-ifame-content">
				...
				<!--<iframe name="content" src="<?php echo U('Index/main');?>" frameborder="0" id="mainframe" scrolling="yes" marginheight="0" marginwidth="0" width="100%" style="height: 700px;"></iframe>-->
				<div class="container">
					<div class="public-nav">您当前的位置：<a href="<?php echo U('Index/index');?>">管理首页</a></div>
					<div class="public-content">
						<div class="public-content-header">
							<h3>网站后台</h3>
						</div>
						<div class="public-content-cont">
							<p style="width: 100%;text-align: center; padding: 50px 0; font-size: 16px; color: #FF0000;"><?php echo ($username); ?> 管理员！ 欢迎登陆网站后台！</p>
						</div>
					</div>
				</div>
